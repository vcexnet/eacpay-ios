...
enum S {
	enum CreateStep {
		...
		enum DetailedMessage {
			static let intro = Localization(key: "DetailedMessage.intro", value: "Take the next 5 minutes to secure your Earthcoin.", comment: "Detailed message for intro")
			static let checkboxes = Localization(key: "DetailedMessage.checkboxes", value: "Sign up for the push notifications to learn Earthcoin news. Unsubscribe any time in Settings", comment: "Settings button label")
		...
		enum ExtendedMessage {
			...
			static let checkboxes = Localization(key: "ExtendedMessage.checkboxes", value: "Enter your email to get updates about Eacpay", comment: "Email sign up website")
		...
		enum Bullet1 {
			static let intro = Localization(key: "Bullet1.intro", value: "Eacpay is from the Earthcoin Foundation and Eacpay Team.", comment: "")
	...
	enum Symbols {
		...
		static func currencyButtonTitle(maxDigits: Int) -> String {
			...
			case 5:
				return "meac\(S.Symbols.narrowSpace)(\(S.Symbols.lites))"
			case 8:
				return "EAC\(S.Symbols.narrowSpace)(\(S.Symbols.ltc))"
			default:
				return "meac\(S.Symbols.narrowSpace)(\(S.Symbols.lites))"
			}
		}
	...
	enum Scanner {
		static let flashButtonLabel = Localization(key: "Scanner.flashButtonLabel", value: "Camera Flash", comment: "Scan Earthcoin address camera flash toggle")
	}
	...
	enum Send {
		...
		static let enterLTCAddressLabel = Localization(key: "Send.enterLTCAddress", value: "Enter EAC Address", comment: "Enter EAC Address")
		...
		static let invalidAddressMessage = Localization(key: "Send.invalidAddressMessage", value: "The destination address is not a valid Earthcoin address.", comment: "Invalid address alert message")
		static let invalidAddressOnPasteboard = Localization(key: "Send.invalidAddressOnPasteboard", value: "Pasteboard does not contain a valid Earthcoin address.", comment: "Invalid address on pasteboard message")
		...
		static let cameraUnavailableTitle = Localization(key: "Send.cameraUnavailableTitle", value: "Eacpay is not allowed to access the camera", comment: "Camera not allowed alert title")
		...
		enum UsedAddress {
			...
			static let firstLine = Localization(key: "Send.UsedAddress.firstLine", value: "Earthcoin addresses are intended for single use only.", comment: "Adress already used alert message - first part")
	...
	enum Litewallet {
		static let name = Localization(key: "Litewallet.name", value: "Eacpay", comment: "Eacpay name")
	}
	...
	enum History {
		...
		static let currentLitecoinValue = Localization(key: "History.currentLitecoinValue", value: "History Current Earthcoin Value", comment: "History Current Earthcoin Value")
	}
	...
	enum JailbreakWarnings {
		...
		static let messageWithBalance = Localization(key: "JailbreakWarnings.messageWithBalance", value: "DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Eacpay's keychain data and steal your Earthcoin! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
		static let messageWithoutBalance = Localization(key: "JailbreakWarnings.messageWithoutBalance", value: "DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Eacpay's keychain data and steal your Earthcoin. Please only use Eacpay on a non-jailbroken device.", comment: "Jailbreak warning message")
	...
	enum UnlockScreen {
		...
		static let touchIdPrompt = Localization(key: "UnlockScreen.touchIdPrompt", value: "Unlock your Eacpay.", comment: "TouchID/FaceID prompt text")
	...
	enum TransactionDetails {
		...
		static let receiveModaltitle = Localization(key: "TransactionDetails.receivedModalTitle", value: "RECEIVE EAC", comment: "RECEIVE EAC Title")
		...
		static let txHashHeader = Localization(key: "TransactionDetails.txHashHeader", value: "Earthcoin Transaction ID", comment: "Transaction ID header")
	...
	enum BuyCenter {
		static let title = Localization(key: "BuyCenter.title", value: "Buy Earthcoin", comment: "Buy Center Title")
		static let buyModalTitle = Localization(key: "BuyCenter.ModalTitle", value: "Buy Єarthcoin", comment: "Buy Modal Title")
		static let buyButtonTitle = Localization(key: "BuyCenter.buyButtonTitle", value: "Buy Є with", comment: "Buy ButtonTitle")
		static let buyDetail = Localization(key: "BuyCenter.buyDetail", value: "Є will be sent to:", comment: "Buy ButtonTitle")
		...
		enum Cells {
			...
			static let simplexFinancialDetails = Localization(key: "BuyCenter.simplexFinancialDetails", value: "• Get Earthcoin in 5 mins!\n• Buy Earthcoin via credit card\n• Passport or State ID", comment: "Simplex buy financial details")
			static let changellyTitle = Localization(key: "BuyCenter.changellyTitle", value: "Changelly", comment: "Changelly Title")
			static let changellyFinancialDetails = Localization(key: "BuyCenter.changellyFinancialDetails", value: "• Change Earthcoin for other cryptos\n• No ID Required\n• Buy via credit card\n• Global coverage", comment: "Changelly buy financial details")
	...
	enum SecurityCenter {
		...
		enum Cells {
			...
			static let pinDescription = Localization(key: "SecurityCenter.pinDescription", value: "Protects your Eacpay from unauthorized users.", comment: "PIN button description")
			static let touchIdTitle = Localization(key: "SecurityCenter.touchIdTitle", value: "Touch ID", comment: "Touch ID button title")
			static let touchIdDescription = Localization(key: "SecurityCenter.touchIdDescription", value: "Conveniently unlock your Eacpay and send money up to a set limit.", comment: "Touch ID/FaceID button description")
			static let paperKeyTitle = Localization(key: "SecurityCenter.paperKeyTitle", value: "Paper Key", comment: "Paper Key button title")
			static let paperKeyDescription = Localization(key: "SecurityCenter.paperKeyDescription", value: "The only way to access your Earthcoin if you lose or upgrade your phone.", comment: "Paper Key button description")
	...
	enum UpdatePin {
		...
		static let createInstruction = Localization(key: "UpdatePin.createInstruction", value: "Your PIN will be used to unlock your Eacpay and send money.", comment: "PIN creation info.")
		...
		static let caption = Localization(key: "UpdatePin.caption", value: "Remember this PIN. If you forget it, you won't be able to access your Earthcoin.", comment: "Update PIN caption text")
	...
	enum RecoverWallet {
		...
		static let intro = Localization(key: "RecoverWallet.intro", value: "Recover your Eacpay with your paper key.", comment: "Recover wallet intro")
	...
	enum AccountHeader {
		static let defaultWalletName = Localization(key: "AccountHeader.defaultWalletName", value: "My Eacpay", comment: "Default wallet name")
	...
	enum TouchIdSettings {
		...
		static let label = Localization(key: "TouchIdSettings.label", value: "Use your fingerprint to unlock your Eacpay and send money up to a set limit.", comment: "Touch Id screen label")
		static let switchLabel = Localization(key: "TouchIdSettings.switchLabel", value: "Enable Touch ID for Eacpay", comment: "Touch id switch label.")
	...
	enum FaceIDSettings {
		...
		static let label = Localization(key: "FaceIDSettings.label", value: "Use your face to unlock your Eacpay and send money up to a set limit.", comment: "Face ID screen label")
		static let switchLabel = Localization(key: "FaceIDSettings.switchLabel", value: "Enable Face ID for Eacpay", comment: "Face id switch label.")
	...
	enum Settings {
		...
		static let enjoying = Localization(key: "Settings.enjoying", value: "Are you enjoying Eacpay?", comment: "Are you enjoying Eacpay alert message body")
		...
		static let litewalletVersion = Localization(key: "Settings.litewallet.version", value: "Eacpay Version:", comment: "Eacpay version")
		static let litewalletEnvironment = Localization(key: "Settings.litewallet.environment", value: "Eacpay Environment:", comment: "Eacpay environment")
		static let socialLinks = Localization(key: "Settings.socialLinks", value: "Social Links:", comment: "Eacpay Social links")
		static let litewalletPartners = Localization(key: "Settings.litewallet.partners", value: "Eacpay Partners:", comment: "Eacpay Partners")
	...
	enum DefaultCurrency {
		...
		static let bitcoinLabel = Localization(key: "DefaultCurrency.bitcoinLabel", value: "Earthcoin Display Unit", comment: "Earthcoin denomination picker label")
	...
	enum ReScan {
		...
		static let body2 = Localization(key: "ReScan.body2", value: "If a transaction shows as completed on the Earthcoin network but not in your Eacpay.", comment: "Syncing explanation")
	...
	enum ShareData {
		...
		static let body = Localization(key: "ShareData.body", value: "Help improve Eacpay by sharing your anonymous data with us. This does not include any financial information. We respect your financial privacy.", comment: "Share data view body")
	...
	enum StartPaperPhrase {
		static let body = Localization(key: "StartPaperPhrase.body", value: "Your paper key is the only way to restore your Eacpay if your mobile is unavailable.\n No one in the Earthcoin Foundation can give this paper key to you!\n\nWe will show you a list of words to write down on a piece of paper and keep safe.\n\nPLEASE MAKE BACKUPS AND DON'T LOSE IT!", comment: "Paper key explanation text.")
	...
	enum MenuButton {
		...
		static let buy = Localization(key: "MenuButton.buy", value: "Buy Earthcoin", comment: "Buy Earthcoin title")
	}
	...
	enum StartViewController {
		...
		static let tagline = Localization(key: "StartViewController.tagline", value: "The most secure and safest way to use Earthcoin.", comment: "Start view message")
	...
	enum Prompts {
		...
		enum PaperKey {
			...
			static let body = Localization(key: "Prompts.PaperKey.body", value: "Your Paper Key must be kept in a safe place. It is the only way modify or restore your Eacpay or transfer your Earthcoin. Please write it down.", comment: "Warning about paper key.")
		}

		enum SetPin {
			static let title = Localization(key: "Prompts.SetPin.title", value: "Set PIN", comment: "Set PIN prompt title.")
			static let body = Localization(key: "Prompts.SetPin.body", value: "Eacpay requires a 6-digit PIN. Please set and store your PIN in a safe place.", comment: "Upgrade PIN prompt body.")
		}
		...
		enum ShareData {
			...
			static let body = Localization(key: "Prompts.ShareData.body", value: "Help improve Eacpay by sharing your anonymous data with us", comment: "Share data prompt body")
		}
	...
	enum PaymentProtocol {
		enum Errors {
			...
			static let smallPayment = Localization(key: "PaymentProtocol.Errors.smallPayment", value: "Earthcoin payments can't be less than %1$@.", comment: "Amount too small error message")
			static let smallTransaction = Localization(key: "PaymentProtocol.Errors.smallTransaction", value: "Earthcoin transaction outputs can't be less than $@.", comment: "Output too small error message.")
	...
	enum LocationPlugin {
		...
		static let notAuthorized = Localization(key: "LocationPlugin.notAuthorized", value: "Eacpay does not have permission to access location services.", comment: "No permissions for location services")
	}
	...
	enum Import {
		...
		static let rightCaption = Localization(key: "Import.rightCaption", value: "Your Eacpay Wallet", comment: "Caption for graphics")
		static let importMessage = Localization(key: "Import.message", value: "Importing a wallet transfers all the money from your other wallet into your Eacpay wallet using a single transaction.", comment: "Import wallet intro screen message")
		...
		static let confirm = Localization(key: "Import.confirm", value: "Send %1$@ from this private key into your wallet? The Earthcoin network will receive a fee of %2$@.", comment: "Sweep private key confirmation message")
	...
	enum WipeWallet {
		...
		static let startMessage = Localization(key: "WipeWallet.startMessage", value: "Starting or recovering another wallet allows you to access and manage a different Eacpay wallet on this device.", comment: "Start wipe wallet view message")
		...
		static let resetTitle = Localization(key: "resetTitle", value: " Delete my Eacpay ", comment: "Warning Empty Wipe title")
		...
		static let warningDescription = Localization(key: "WipeWallet.warningDescription", value: "Your Eacpay is empty. Resetting will delete the old private key and wipe the app data.\n\nAfter the reset, be prepared to record the new 12 words and keep them in a very secure place.\n\nNo Eacpay developers can retrieve this seed for you.", comment: "Warning description")
	...
	enum NodeSelector {
		...
		static let title = Localization(key: "NodeSelector.title", value: "Earthcoin Nodes", comment: "Node Selector view title")
	...
	enum Welcome {
		static let title = Localization(key: "Welcome.title", value: "Welcome to Eacpay", comment: "Welcome view title")
		static let body = Localization(key: "Welcome.body", value: "Eacpay now has a brand new look and some new features.\n\nAll coins are displayed in meac (є). 1 Earthcoin (Є) = 1000 meac (є).", comment: "Welcome view body text")
	}

	enum ShowWords {
		static let modalTitle = Localization(key: "ShowWords.modalTitle", value: "Show seed phrase", comment: "ShowWords.modalTitle")
		static let titleWarning = Localization(key: "ShowWords.titleWarning", value: "These are your seed words. If you show them to anyone, they can take your Earthcoin", comment: "ShowWords.titleWarning")
	}
