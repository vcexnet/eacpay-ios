...
extension UIColor {
    ...
    static var litewalletOrange: UIColor { // FE5F55
    ...
    static var litewalletLime: UIColor { // D9E76C
        return #colorLiteral(red: 0.8509803922, green: 0.9058823529, blue: 0.4235294118, alpha: 1)
    }
