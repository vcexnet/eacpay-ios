...
class AboutViewController: UIViewController {
	...
	private func setActions() {
		blog.button.tap = strongify(self) { myself in
			myself.presentURL(string: "https://earthcoin.online")
		}
		twitter.button.tap = strongify(self) { myself in
			myself.presentURL(string: "https://twitter.com/Eacpay")
		}
		reddit.button.tap = strongify(self) { myself in
			myself.presentURL(string: "https://www.reddit.com/r/earthcoin/")
		}
		privacy.tap = strongify(self) { myself in
			myself.presentURL(string: "https://earthcoin.online/policy.html")
		}
	}
